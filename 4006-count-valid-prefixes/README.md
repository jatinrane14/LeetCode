<h2><a href="https://leetcode.com/problems/count-valid-prefixes/?envType=problem-list-v2&envId=string">4365. Count Valid Prefixes</a></h2><h3>Easy</h3><hr><p>You are given a <span data-keyword="binary-string">binary string</span> <code>s</code>.</p>
